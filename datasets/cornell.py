...
class CornellLoader(BaseGraphLoader):
...
def load_cornell_federated(num_clients=10, iid=False, seed=42):
    loader = CornellLoader(num_clients=num_clients, iid=iid, seed=seed)
