...
class TexasLoader(BaseGraphLoader):
...
def load_texas_federated(num_clients=10, iid=False, seed=42):
    loader = TexasLoader(num_clients=num_clients, iid=iid, seed=seed)
