...
class PubMedLoader(BaseGraphLoader):
...
def load_pubmed_federated(num_clients=10, iid=False, seed=42):
    loader = PubMedLoader(num_clients=num_clients, iid=iid, seed=seed)
