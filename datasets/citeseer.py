...
class CiteseerLoader(BaseGraphLoader):
...
def load_citeseer_federated(num_clients=10, iid=False, seed=42):
    loader = CiteseerLoader(num_clients=num_clients, iid=iid, seed=seed)
